...
tab = tt.Texttable()
print("Time spend writing hdf5 data and file sizes:")
headings = [" ", "Time (s)", "Size (bytes)"]
tab.header(headings)
content = []
content.append(["uncompressed random data", os.stat(tempfiles[0].name).st_size,
    pstats.Stats(cps[0]).total_tt])
content.append(["uncompressed random data", os.stat(tempfiles[1].name).st_size,
    pstats.Stats(cps[1]).total_tt])
content.append(["uncompressed random data", os.stat(tempfiles[2].name).st_size,
    pstats.Stats(cps[2]).total_tt])
content.append(["uncompressed random data", os.stat(tempfiles[3].name).st_size,
    pstats.Stats(cps[3]).total_tt])
